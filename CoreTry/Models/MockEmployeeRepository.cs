...
namespace CoreTry.Models
{
    public class MockEmployeeRepository : IEmployeeRepository
    {
        ...
        public MockEmployeeRepository()
        {
            ...
            {
                new Employee() {Id=1,Name="Mary", Department=Dept.IT, Email="mary@gmail.com"}
        ...
        IQueryable<Employee> IEmployeeRepository.GetAllEmployees()
        {
            return _employeeList.ToList().AsQueryable();
        }
    }
}
